...
// {    
//     public partial class BootData : DataObject<BootData.Boot>
//     {
//         [Serializable]
//         public class Boot : IIdentifier
//         {
...
//         public readonly string WorkSheetName = "Boot";    
//   
//         private void LoadFromJson()
//         {
//     
//             List = UnityGoogleSheet.Editor.Core.UgsEditorUtility
//                 .LoadFromJson<Boot>("EquipmentData"); 
//         }
//         
//         private void LoadFromGoogleSpreadSheet()
//         {
//             UnityGoogleSheet.Editor.Core.UgsExplorer
//                 .ParseSpreadSheet(SpreadSheetID, "Boot");
//
//             LoadFromJson();
