Shader "Universal Render Pipeline/2D/D2D Sprite-Lit-Default"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 CombinedShapeLightFragment(Varyings i) : SV_Target
            {
                ...
                // D2D
                D2dModifyColorAndAlpha(main.rgb, main.a, i.localPos);
        ...
        Pass
        {
            ...
            Varyings NormalsRenderingVertex(Attributes attributes)
            {
                ...
                // D2D
                o.localPos = attributes.positionOS.xy;
            ...
            half4 NormalsRenderingFragment(Varyings i) : SV_Target
            {
                ...
                // D2D
                D2dModifyColorAndAlpha(mainTex.rgb, mainTex.a, i.localPos);
