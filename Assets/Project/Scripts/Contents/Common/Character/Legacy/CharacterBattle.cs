...
namespace Common.Character
{
    ...
    public class CharacterBattle : MonoBehaviour
    {
        ...
        [SerializeField] private List<SkillAttribution> skillList;

        private SkillAttribution nextSKill;
        public string AnimationKey => nextSKill.AnimationKey;

        public void Invoke(ICombatAttribution combatInfo) => nextSKill.Invoke(combatInfo);
