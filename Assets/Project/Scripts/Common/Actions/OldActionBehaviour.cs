...
{
    public class OldActionBehaviour : MonoBehaviour, IActionBehaviour, IEditable
    {
        ...
        // => skillAction.Activate(skill, targetPosition); 

        public void ActiveSkill(SkillComponent skill, Vector3 targetPosition)
        {
            if (!skillAction.IsAble(skill)) return;

            skillAction.ActiveSkill(skill, targetPosition);
            
            // DisableActions(skill.DisableActionMask, "byRigidSkill");
            // skill.OnEnded.Register("ReleaseAction", () => EnableActions(skill.DisableActionMask, "byRigidSkill"));
        }
        ...
        private void OnEnable()
        {
            ...
            // stunAction.OnActivated.Register("Stop", tempCharacter.Stop);
            ...
            // knockBackAction.OnActivated.Register("Stop", tempCharacter.Stop);
            // knockBackAction.OnActivated.Register("Rotate", tempCharacter.Rotate);
            ...
            // deadAction.OnActivated.Register("Stop", tempCharacter.Stop);
