...
namespace Common
{
    public enum MaterialType
    {
        ...
        VirtuousShard = DataIndex.Votivecrystal,
        VirtuousStone = DataIndex.Virtuousshard,
        VirtuousCrystal = DataIndex.Virtuousstone,
        ViciousShard = DataIndex.Virtuouscrystal,
        ViciousStone = DataIndex.Viciousshard,
        ViciousCrystal = DataIndex.Viciousstone,
    }
