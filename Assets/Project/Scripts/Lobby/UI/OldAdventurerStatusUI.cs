...
namespace Lobby.UI
{
    public class OldAdventurerStatusUI : MonoBehaviour, IEditable
    {
        ...
        [SerializeField] private List<OldEquipmentInfoUI> equipmentInfoList;
        ...
        public void Reload()
        {
            var adventurerData = Camp.GetData(dataIndex);
        ...
        private OldEquipmentInfoUI GetEquipmentUI(EquipmentSlotType type) => equipmentInfoList.TryGetElement(equip => equip.EquipSlot == type);
