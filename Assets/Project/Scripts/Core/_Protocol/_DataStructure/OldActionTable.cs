...
namespace Core
{
    public class OldActionTable : DelegateTable<int, Action>
    {
        public OldActionTable(){}
        public OldActionTable(int capacity) : base(capacity) {}
    ...
    public class OldActionTable<T0> : DelegateTable<int, Action<T0>>
    {
        public OldActionTable(){}
        public OldActionTable(int capacity) : base(capacity) {}
    ...
    public class OldActionTable<T0, T1> : DelegateTable<int, Action<T0, T1>>
    { 
        public OldActionTable(){}
        public OldActionTable(int capacity) : base(capacity) {}
