...
using Upgrade = Databases.SheetData.ContentData.UpgradesData.Upgrades;
...
public partial class Database : MonoSingleton<Database>, IEditable
{
    ...
    public static Upgrade UpgradeSheetData(DataIndex dataIndex) => SheetDataTable[DataIndex.Upgrades].Get<Upgrade>(dataIndex);
