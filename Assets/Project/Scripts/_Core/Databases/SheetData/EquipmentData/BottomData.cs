...
{    
    public partial class BottomData : DataObject<BottomData.Bottom>
    {
        [Serializable]
        public class Bottom : IIdentifier
        {
...
#region Editor Functions.
        ...
        public readonly string WorkSheetName = "Bottom";    
  
        private void LoadFromJson()
        {
    
            List = UnityGoogleSheet.Editor.Core.UgsEditorUtility
                .LoadFromJson<Bottom>("EquipmentData"); 
        }
        
        private void LoadFromGoogleSpreadSheet()
        {
            UnityGoogleSheet.Editor.Core.UgsExplorer
                .ParseSpreadSheet(SpreadSheetID, "Bottom");
