...
{    
    public partial class TopData : DataObject<TopData.Top>
    {
        [Serializable]
        public class Top : IIdentifier
        {
...
#region Editor Functions.
        ...
        public readonly string WorkSheetName = "Top";    
  
        private void LoadFromJson()
        {
    
            List = UnityGoogleSheet.Editor.Core.UgsEditorUtility
                .LoadFromJson<Top>("EquipmentData"); 
        }
        
        private void LoadFromGoogleSpreadSheet()
        {
            UnityGoogleSheet.Editor.Core.UgsExplorer
                .ParseSpreadSheet(SpreadSheetID, "Top");
