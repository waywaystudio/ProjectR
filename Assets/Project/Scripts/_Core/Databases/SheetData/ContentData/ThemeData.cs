...
{    
    public partial class ThemeData : DataObject<ThemeData.Theme>
    {
        [Serializable]
        public class Theme : IIdentifier
        {
...
#region Editor Functions.
        ...
        public readonly string WorkSheetName = "Theme";    
  
        private void LoadFromJson()
        {
    
            List = UnityGoogleSheet.Editor.Core.UgsEditorUtility
                .LoadFromJson<Theme>("ContentData"); 
        }
        
        private void LoadFromGoogleSpreadSheet()
        {
            UnityGoogleSheet.Editor.Core.UgsExplorer
                .ParseSpreadSheet(SpreadSheetID, "Theme");
