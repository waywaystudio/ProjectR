...
{    
    public partial class MaterialData : DataObject<MaterialData.Material>
    {
        [Serializable]
...
#region Editor Functions.
        ...
        public readonly string WorkSheetName = "Material";    
  
        private void LoadFromJson()
        {
    
            List = UnityGoogleSheet.Editor.Core.UgsEditorUtility
                .LoadFromJson<Material>("ItemData"); 
        }
        
        private void LoadFromGoogleSpreadSheet()
        {
            UnityGoogleSheet.Editor.Core.UgsExplorer
                .ParseSpreadSheet(SpreadSheetID, "Material");
