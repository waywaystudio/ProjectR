...
namespace Character.Combat.StatusEffects
{
    ...
    public class StatusEffecting : MonoBehaviour
    {
        ...
        public void TryAdd(ICombatEntity entity)
        {
            BaseStatusEffect statusEffect;
            
            switch (entity.Provider.ActionCode)
            {
                case IDCode.BloodDrainBuff : statusEffect = GenerateStatusEffect<BloodDrainBuff>(entity); break;
                case IDCode.CorruptionDeBuff : statusEffect = GenerateStatusEffect<CorruptionDeBuff>(entity); break;
                case IDCode.FireballDeBuff : statusEffect = GenerateStatusEffect<FireballDeBuff>(entity); break;
                case IDCode.FuryBuff : statusEffect = GenerateStatusEffect<FuryBuff>(entity); break;
                case IDCode.RoarDeBuff : statusEffect = GenerateStatusEffect<RoarDeBuff>(entity); break;
        ...
        public void TryRemove(IDCode key)
        {
        ...
        private T GenerateStatusEffect<T>(IOrigin entity) where T : BaseStatusEffect, new()
        {
            ...
            return new T
            {
                ActionCode = (IDCode)statusEffectData.ID,
