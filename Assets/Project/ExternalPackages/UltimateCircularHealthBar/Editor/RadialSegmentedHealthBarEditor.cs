...
namespace RengeGames.HealthBars.Editors {
    ...
    public class RadialSegmentedHealthBarEditor : UnityEditor.Editor {
        ...
        public override void OnInspectorGUI() {
            ...
            using (new EditorGUILayout.HorizontalScope(EditorStyles.helpBox)) {
                ...
                GUILayout.BeginVertical();
                {
                    ...
                    if (GUILayout.Button(new GUIContent("Use Sprite Renderer Component", "Use a sprite renderer to diplay the progress bar."))) {
                        foreach (var serializedObjectTargetObject in serializedObject.targetObjects) {
                            if (serializedObjectTargetObject != null) {
                                var obj = serializedObjectTargetObject as RadialSegmentedHealthBar;
                    ...
                    if (GUILayout.Button(new GUIContent("Use Image Component", "Use an image component to display the progress bar. Always use when in a canvas context"))) {
                        foreach (var serializedObjectTargetObject in serializedObject.targetObjects) {
                            if (serializedObjectTargetObject != null) {
                                var obj = serializedObjectTargetObject as RadialSegmentedHealthBar;
