...
{
    [ExecuteAlways] [DisallowMultipleComponent] [AddComponentMenu("Health Bars/Compound Health Bar")]
    public class CompoundHealthBar : MonoBehaviour, ISegmentedHealthBar
    {
        ...
        [Space] [SerializeField] bool segmentsToggle = true;
        ...
        [Space] [SerializeField] private List<string> healthBarNames;
        ...
        float TotalSegmentCount() { return healthBars.Aggregate(0, (sum, next) => sum += (int)(next as RadialSegmentedHealthBar).SegmentCount.Value); }

        float SegmentCount(ISegmentedHealthBar hb) { return (hb as RadialSegmentedHealthBar).SegmentCount.Value; }


        #region unused methods

        public bool SetShaderKeywordValue(string propertyName, bool value) { return false; }

        public bool SetShaderPropertyValue<T>(string propertyName, T value) { return false; }
