...
namespace QcPrimitives
{
    ...
    public class QcGridMesh : QcPrimitivesBase
    {
        ...
        protected override void BuildGeometry()
        {
            ...
            bool withSides = (properties.depth != 0.0f);

            GenerateVertices(withSides);
            GenerateTriangles(withSides);
        ...
        private void GenerateTriangles(bool withSides)
        {
            faces.Clear();
        ...
        private void SetTextureCoords(bool withSides)
        {
            if (!properties.genTextureCoords) return;
