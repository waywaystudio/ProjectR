...
namespace BehaviorDesigner.Runtime
{
    ...
    public class BehaviorSource : IVariableSource
    {
        ...
        public List<SharedVariable> Variables { get { return mVariables; } set { SetAllVariables(value); } }
        ...
        public bool CheckForSerialization(bool force, BehaviorSource behaviorSource = null)
        {
            ...
            if (mTaskData != null && (!HasSerialized || force)) {
                ...
                if (!string.IsNullOrEmpty(mTaskData.JSONSerialization)) {
                    JSONDeserialization.Load(mTaskData, behaviorSource == null ? this : behaviorSource, Application.isPlaying|| behaviorSource == null);
                } else { // binary serialization
                    BinaryDeserialization.Load(mTaskData, behaviorSource == null ? this : behaviorSource, Application.isPlaying|| behaviorSource == null);
                }
                return true;
            }
            return false;
